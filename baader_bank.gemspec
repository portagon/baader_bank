...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Portagon"]
  spec.email = ["e.mueller@portagon.com"]

  spec.summary = "Ruby client for the Baader Bank Customer REST API"
  spec.description = "Encapsulates authentication, error handling, and resource methods for the Baader Bank " \
